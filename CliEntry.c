...
#define DOM_TAG_HTML   1 
#define DOM_TAG_BODY   2 
#define DOM_TAG_HEAD   3 
#define DOM_TAG_SCRIPT   4 
#define DOM_TAG_LINK   5 
#define DOM_TAG_TITLE   6 
#define DOM_TAG_H1   7 

#define DOM_ATTR_HREF   1 
#define DOM_ATTR_REL   2 
#define DOM_ATTR_SRC   4 
